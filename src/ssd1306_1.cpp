 ...
 */
void SSD1306::ssd1306I2CSetup(uint8_t i2cAddr)
{
    // init I2C interface
    // int fd;
 ...
 */
void SSD1306::draw(int x, int y, unsigned char ascii)
{
 ...
 */
void SSD1306::draw_line(int x ,int y,unsigned char ascii_str[16]){

	int i;
	for(i = 0; i < strlen((char *)ascii_str); i++){
