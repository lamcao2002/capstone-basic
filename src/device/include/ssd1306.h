...
public:
    ...
    void config();
    uint8_t ssd1306_end();
    void ssd1306_oled_onoff(uint8_t onoff);
    void ssd1306_oled_horizontal_flip(uint8_t flip);
    void ssd1306_oled_display_flip(uint8_t flip);
    void ssd1306_oled_multiplex(uint8_t row);
    void ssd1306_oled_vert_shift(uint8_t offset);
    void ssd1306_oled_set_clock(uint8_t clk);
    void ssd1306_oled_set_precharge(uint8_t precharge);
    void ssd1306_oled_set_deselect(uint8_t voltage);
    void ssd1306_oled_set_com_pin(uint8_t value);
    void ssd1306_oled_set_mem_mode(uint8_t mode);
    void ssd1306_oled_set_col(uint8_t start, uint8_t end);
    void ssd1306_oled_set_page(uint8_t start, uint8_t end);
    void ssd1306_oled_set_constrast(uint8_t value);
    void ssd1306_oled_scroll_onoff(uint8_t onoff);
    void ssd1306_oled_set_X(uint8_t x);
    void ssd1306_oled_set_Y(uint8_t y);
    void ssd1306_oled_set_XY(uint8_t x, uint8_t y);
    void ssd1306_oled_set_rotate(uint8_t degree);
    void ssd1306_oled_write_line(uint8_t size, char *ptr);
    void ssd1306_oled_write_string(uint8_t size, char *ptr);
